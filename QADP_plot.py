...
# ===================== Parameters =====================
# pkt_prob = 0.5
lambda_arr = np.arange(1, 11, 1)
for slice_num in lambda_arr:
    pkt_prob = 0.5
    e_prob = 0.5
    weight_prob = 0.5
    ...
    all_states = all_states[::slice_num]  # subsample
    ...
    def policy_run(T_horizon, P_opt, q_opt, r_opt):
        ...
        print(slice_num)
        print('obj', tot_dist/(T_horizon))
        print('-------------------------------')


    # print("Running policy simulation...")
    policy_run(501, P_opt, q_opt, r_opt)
